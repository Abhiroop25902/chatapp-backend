...
public class MessageController {
    ...
    @Secured("ROLE_USER")
    @PatchMapping("/api/v1/message")
    ResponseEntity<MessageCreateOrUpdateResponseDto> updateMessage(@RequestBody MessagePatchRequestDto messagePatchRequestDto) {
        final var message = messageService.updateMessage(messagePatchRequestDto);
